...
class DrivesControllerTest < ActionController::TestCase
  ...
  test "should create drife" do
    assert_difference('Drive.count') do
      post :create, drife: { city: @drife.city, driver_id: @drife.driver_id, num_passengers: @drife.num_passengers }
    end
  ...
  test "should update drife" do
    patch :update, id: @drife, drife: { city: @drife.city, driver_id: @drife.driver_id, num_passengers: @drife.num_passengers }
    assert_redirected_to drife_path(assigns(:drife))
  end
